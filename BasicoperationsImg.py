...
# A Simple program to read an image using opencv functions and apply basic operations
# on the image
...
print Img.dtype         # display image data type
print Img.size          # display image size
px=np.array([0,0,0])    # create an 1-D empty array 
pix=Img[100,100]        # access pixel value  
print pix               # print the pixel value
ball=Img[280:290,300:310]  # Access ROI of image
Img[270:280,100:110] = ball  # replace portion of Image by ROI
